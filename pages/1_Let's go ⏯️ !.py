...
def main():
    ...
    st.markdown('You\'re probably here because you told yourself :blue["I can do something with this data"] :light_bulb: and you\'re right. But before, we need to know how complex your data is, so we now what we have to deal with :boxing_glove:')
